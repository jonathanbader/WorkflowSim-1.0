...
nohup java -jar WorkflowSim-1.0-1.0-SNAPSHOT.jar chipseq normal 0 &
...
nohup java -jar WorkflowSim-1.0-1.0-SNAPSHOT.jar chipseq normal 0.25 &

nohup java -jar WorkflowSim-1.0-1.0-SNAPSHOT.jar chipseq exponential 0 &
...
nohup java -jar WorkflowSim-1.0-1.0-SNAPSHOT.jar sarek normal 0.25 &

nohup java -jar WorkflowSim-1.0-1.0-SNAPSHOT.jar sarek exponential 0 &
